...
class AddVerifiedToDocumentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('documents', function (Blueprint $table) {
            $table->foreignId('legal_drafter')->constrained('users')->nullable();
            $table->foreignId('admin_verified')->constrained('users')->nullable();
            $table->dateTime('admin_verified_at')->nullable();
            $table->foreignId('legal_drafter_verified')->constrained('users')->nullable();
            $table->dateTime('legal_drafter_verified_at')->nullable();
            $table->foreignId('suncang_verified')->constrained('users')->nullable();
            $table->dateTime('suncang_verified_at')->nullable();
            $table->foreignId('kasubag_verified')->constrained('users')->nullable();
            $table->dateTime('kasubag_verified_at')->nullable();
            $table->text('kasubag_verified_sign')->nullable();
            $table->foreignId('kabag_verified')->constrained('users')->nullable();
            $table->dateTime('kabag_verified_at')->nullable();
            $table->text('kabag_verified_sign')->nullable();
            $table->foreignId('asistant_verified')->constrained('users')->nullable();
            $table->dateTime('asistant_verified_at')->nullable();
            $table->text('asistant_verified_sign')->nullable();
            $table->foreignId('sekda_verified')->constrained('users')->nullable();
